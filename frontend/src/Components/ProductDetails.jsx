...
const ProductDetails = () => {
  ...
  const [palceholderValue, setpalceholderValue] = useState("search");
  const [palceholderValueTwo, setpalceholderValueTwo] = useState("search");
  ...
  return (
    <>
          ...
          {productsTwo.map((product) => (
            <div className="child" key={product._id}>
              <div className="subbox">
                ...
                <input
                  type="text"
                  placeholder={palceholderValueTwo}
                  ...
                  {searchDataTwo.map((data, index) => (
                    <a
                      ...
                      onClick={() => {
                        ...
                        setSearchDataTwo([]);
                        setSearchTwo("");
                        setpalceholderValueTwo(data.name);
                      }}
                    >
                      {data.name}
                    </a>
      ...
      <Header />
      <DetailsTable  products={products} productsTwo={productsTwo}/>
    </>
  );
};
